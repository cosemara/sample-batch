...
public class UsePassesJobConfig {
    ...
    public static final String JOB_NAME = "usePassesJob";
    ...
    @Bean(JOB_NAME)
    public Job usePassesJob(final JobRepository jobRepository, @Qualifier(BEAN_PREFIX + "usePassesStep") final Step usePassesStep) {
        return new JobBuilder("usePassesJob", jobRepository)
                                     .start(usePassesStep)
                                     .build();
    }

    @Bean(BEAN_PREFIX + "usePassesStep")
    public Step usePassesStep(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
