...
@SpringBootTest
@ActiveProfiles("test")
@ContextConfiguration(classes = {AddPassesJobConfig.class, TestBatchConfig.class, AddPassesTasklet.class, TestJobUtil.class})
public class AddPassesJobConfigTest {
    ...
    public void test_addPassesJob() throws Exception {
        ...
        // when
        JobExecution jobExecution = testJobUtil.getJobTester("addPassesJob").launchJob();
